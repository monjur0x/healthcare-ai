> **SUPERSEDED** — This file is a historical snapshot of the milestone
> checklists from the early phases. The live backlog is maintained at
> `.ai/backlog.md`. Do not update this file; update `.ai/backlog.md` instead.
